# CLAUDE.md — Theatre Company Founding Project

## Project Summary

This repository contains the founding documents and digital artifacts for a professional theatre company being built in Chicago by **Topher Rasmussen** and **Cassandra Stokes-Wylie**. The first production is Lucas Hnath's *The Thin Place* — staged reading in October 2026, full production in October 2027.
...
- **Feb – May 2026**: Foundation (fiscal sponsorship, licensing inquiry, venue visits, Equity call)
- **Jun – Oct 2026**: The Reading (cast, rehearse, execute staged reading under 29-Hour Code)
- **Nov 2026 – Apr 2027**: Organization building (501(c)(3), board, fundraising)
- **May – Oct 2027**: The Production (rehearsals, tech, previews, opening, run)

## Git Configuration

- **Account**: topher416 — `Topher Rasmussen <topher416@gmail.com>`
- **Remote**: HTTPS (SSH not configured for this account)
- **Repo**: private
...
- Use complete sentences and maintain formal language in all professional content.
- Be conservative and honest about data sources — never overstate or embellish claims.
- The artistic identity centers on: plays that move audiences, intimate scale, rigorous craft, earned-revenue primacy, and the belief that the work itself is the primary argument for the company's existence.
